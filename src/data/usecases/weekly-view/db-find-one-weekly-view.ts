...
export class DbFindOneWeeklyView implements FindOneWeeklyView {
  constructor(private readonly findOneWeeklyViewRepository: FindOneWeeklyViewRepository) {}

  async findOne(data: FindOneWeeklyView.Params): Promise<FindOneWeeklyView.Result> {
