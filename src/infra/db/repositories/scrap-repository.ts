import { CancleScrapRepository, ScrapPostRepository } from "@/data/protocols/db/scrap";
import { Scrap } from "@/domain/entities";
import { EntityRepository, getRepository } from "typeorm";

@EntityRepository(Scrap)
export class ScrapRepository implements ScrapPostRepository, CancleScrapRepository {
